...
transform MenuLightRed:
    mesh True
    shader "MakeVisualNovels.SimulatedLighting"  
    u_key_light_color (0.1, 0.2, 0.1)
    u_rim_light_color (0.0,0.0,1.0)  
    u_rim_light_radius (0)
    u_rim_light_position (0.5,0.3)
    u_fill_light_color (1.0, 0.2, 0.2)
    u_fill_light_direction (1.0, 0.0)  
    u_rim_light_intensity (0)          
    u_fill_light_intensity (0)  
    ...
    u_key_light_radius (0.6)  
    u_key_light_position (0.2, 0.2)
    u_key_light_intensity (.7)
    block:  
        u_rim_light_radius (0.5)
        u_rim_light_position (1.0,0.5)
        ease 0.10 u_key_light_color (1.0, 0.1, 0.1)   
        u_rim_light_color (1.0, 0.1, 0.1)
        pause 0.05
        ease 0.5 u_rim_light_color (1.0,0.5,0)
        ease 0.5 u_rim_light_radius (15)
        pause 0.05
        ease 0.5 u_rim_light_color (1.0,1.0,0)
        ease 0.5 u_rim_light_radius (0)
        pause 0.05
        repeat  
# A Preset for the Simulated Lighting Shader
# Caution should be exercised when applied to characters
